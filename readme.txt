Onepoint Project 06.1 Open Edition
==================================
...
* MySQL 5.0.27, PostgreSQL 8.1, or IBM DB2 9

* MySQL or PostgreSQL JDBC driver

* Apache Tomcat 5.5 or IBM Websphere

Other application servers or databases (e.g., Oracle 10g) on demand.
...
If you are upgrading from Onepoint Project 06.1 Open Edition Beta, please move your
