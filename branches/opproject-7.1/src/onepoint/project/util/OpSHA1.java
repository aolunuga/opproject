...
/*
 * OpSHA1.java - An implementation of the SHA-1 Algorithm
 *
 * This version is derived from code which has been put into
 * public domain by Chuck McManis (cmcmanis@netcom.com).
 *
...
public final class OpSHA1 extends OpHashFunction
{
   ...
   */
   ...
   public String getHashString() {
      return getHashString(false);
   }

   public String getHashString(boolean space) {
