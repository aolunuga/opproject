...
public final class OpLocator {
   ...
   public OpLocator(OpObjectIfc object) {
   ...
   public static String locatorString(OpLocatable opLocatable) {
      return locatorString(OpTypeManager.getPrototypeForObject(opLocatable), opLocatable.getId());
   }
