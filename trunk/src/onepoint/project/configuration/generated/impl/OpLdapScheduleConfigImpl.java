...
public class OpLdapScheduleConfigImpl implements onepoint.project.configuration.generated.OpLdapScheduleConfig, com.sun.xml.bind.JAXBObject, onepoint.project.configuration.generated.impl.runtime.UnmarshallableObject, onepoint.project.configuration.generated.impl.runtime.XMLSerializable, onepoint.project.configuration.generated.impl.runtime.ValidatableObject
{
    ...
    {
        int idx1 = 0;
        final int len1 = ((_DayOfMonth == null)? 0 :_DayOfMonth.size());
        int idx2 = 0;
        final int len2 = ((_Hour == null)? 0 :_Hour.size());
        int idx3 = 0;
        final int len3 = ((_Minute == null)? 0 :_Minute.size());
        int idx4 = 0;
        final int len4 = ((_Month == null)? 0 :_Month.size());
        int idx5 = 0;
        final int len5 = ((_DayOfWeek == null)? 0 :_DayOfWeek.size());
        while (idx3 != len3) {
            ...
            try {
                context.text(((java.lang.String) _Minute.get(idx3 ++)), "Minute");
            } catch (java.lang.Exception e) {
                onepoint.project.configuration.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        ...
        while (idx2 != len2) {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) _Hour.get(idx2 ++)), "Hour");
            } catch (java.lang.Exception e) {
                onepoint.project.configuration.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        ...
        while (idx4 != len4) {
            ...
            context.endAttributes();
            try {
                context.text(((java.lang.String) _Month.get(idx4 ++)), "Month");
            } catch (java.lang.Exception e) {
                onepoint.project.configuration.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
            }
            context.endElement();
        ...
        if ((((_DayOfWeek == null)? 0 :_DayOfWeek.size()) == 0)&&(((_DayOfMonth == null)? 0 :_DayOfMonth.size())>= 1)) {
            while (idx1 != len1) {
                ...
                context.endAttributes();
                try {
                    context.text(((java.lang.String) _DayOfMonth.get(idx1 ++)), "DayOfMonth");
                } catch (java.lang.Exception e) {
                    onepoint.project.configuration.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
                }
                context.endElement();
            ...
            if ((((_DayOfWeek == null)? 0 :_DayOfWeek.size())>= 1)&&(((_DayOfMonth == null)? 0 :_DayOfMonth.size()) == 0)) {
                while (idx5 != len5) {
                    ...
                    context.endAttributes();
                    try {
                        context.text(((java.lang.String) _DayOfWeek.get(idx5 ++)), "DayOfWeek");
                    } catch (java.lang.Exception e) {
                        onepoint.project.configuration.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
                    }
                    context.endElement();
...
+"ssionPool;xp\u0000\u0000\u0000\u0013\u0001pq\u0000~\u0000\u000fq\u0000~\u0000>q\u0000~\u0000Eq\u0000~\u0000Mq\u0000~\u0000Tq\u0000~\u0000Jq\u0000~\u0000\u0005q\u0000~\u0000%q\u0000"
+"~\u0000?q\u0000~\u0000Fq\u0000~\u0000Nq\u0000~\u0000Uq\u0000~\u0000\u0007q\u0000~\u0000\nq\u0000~\u0000<q\u0000~\u0000Cq\u0000~\u0000Kq\u0000~\u0000Rq\u0000~\u0000\u0006x"));
        }
