...
public class OpNewConfigurationHandler {
    ...
    * the logger
    */
   private static final XLog logger = XLogFactory.getLogger(OpNewConfigurationHandler.class);
...
//       unmarshaller.setValidating(true);
         ...
         File configFile = new File("/usr/users/dfreis/projects/opproject-8/opproject_closed/src/onepoint/project/team/test/configuration.oxc.xml");
