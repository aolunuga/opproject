...
public class OpContentService extends OpProjectService {
   ...
   private final static String DELETE_OBJECTS_WITH_ID = "delete from OpObject obj where obj.ID in (:objectIds)";
   ...
   void deleteZeroRefContentsWithIds(OpBroker broker, List<Long> contentIds) {
      ...
      if (ids != null && !ids.isEmpty()) {
         OpQuery deleteQuery = broker.newQuery(DELETE_OBJECTS_WITH_ID);
