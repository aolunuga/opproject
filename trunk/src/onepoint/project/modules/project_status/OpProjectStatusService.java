...
public class OpProjectStatusService extends OpProjectService {
   ...
   private static final XLog logger = XLogFactory.getLogger(OpProjectStatusService.class);
   ...
   public XMessage move(OpProjectSession session, XMessage request) {
      ...
      try {
         ...
         SortedMap sortOrder = new TreeMap();
   ...
   public XMessage deleteProjectStatus(OpProjectSession session, XMessage request) {
      ...
      try {
         OpTransaction t = broker.newTransaction();
         doDeleteProjectStatus(id_strings, broker);
         t.commit();
    ...
    * @post
    */
   public static void doDeleteProjectStatus(List id_strings, OpBroker broker) {
