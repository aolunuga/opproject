...
public class OpUserServiceTest extends OpBaseOpenTestCase {
   ...
   public void testValidLogin()
      ...
      OpProjectCalendar calendar = (OpProjectCalendar) variables.get(OpProjectConstants.CALENDAR);
   ...
   public void testSystemDefaultLanguage()
      ...
      logOut();
      String systemLocaleId = XLocaleManager.findLocale(OpSettingsService.getService().getStringValue(session, OpSettings.USER_LOCALE_ID)).getID();
