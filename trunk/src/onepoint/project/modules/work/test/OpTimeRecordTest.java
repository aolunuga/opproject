...
public class OpTimeRecordTest extends OpTestCase {
   ...
   public void testValidOpTimeRecords()
      ...
      OpWorkTestDataFactory.setFieldsOnTimeRecord(timeRecord, 35, OpProjectCalendar.MINUTES_PER_DAY - 1, OpProjectCalendar.MINUTES_PER_DAY - 36);
      timeRecord.validate();

      //start - end: 0 - 24 * 60 -1
      OpWorkTestDataFactory.setFieldsOnTimeRecord(timeRecord, 0, OpProjectCalendar.MINUTES_PER_DAY - 1, OpProjectCalendar.MINUTES_PER_DAY - 1);
      timeRecord.validate();
   ...
   public void testInvalidOpTimeRecords()
      ...
      //start > 24 * 60
      exceptionThrown = false;
      timeRecord.setStart(OpProjectCalendar.MINUTES_PER_DAY + 5);
      timeRecord.setFinish(OpProjectCalendar.MINUTES_PER_DAY + 10);
      try {
         timeRecord.validate();
      }
      catch (OpEntityException e) {
      ...
      timeRecord.setFinish(OpProjectCalendar.MINUTES_PER_DAY);
      try {
         timeRecord.validate();
      }
      catch (OpEntityException e) {
