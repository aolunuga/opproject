...
public class OpAttachmentDataSetFactory {
   ...
   public static final String ATTACHMENT_DOCUMENT = "d";

   //indexes
   public static final int ATTACHMENT_TYPE_INDEX = 0;
   public static final int ATTACHMENT_LOCATOR_INDEX = 1;
   public static final int ATTACHMENT_NAME_INDEX = 2;
   public static final int ATTACHMENT_LOCATION_INDEX = 3;
   public static final int ATTACHMENT_CONTENT_ID_INDEX = 4;
