...
public class OpProjectTestDataFactory extends OpTestDataFactory {
   ...
   public String getActivityAssignmentId(String activityName) {
      ...
      try {
         ...
         if (assignmentId != null) {
            return OpLocator.locatorString(OpAssignmentIfc.ASSIGNMENT, assignmentId);
         }
      }
      finally {
         broker.close();
    ...
    */
   public static double addRateForDays(Date startDate, Date endDate, OpProjectCalendar xCalendar, double currentTotal, double rateToAdd) {
