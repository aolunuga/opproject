 ...
 */
public class OpMyTasksTestDataFactory extends OpTestDataFactory {
    ...
    */
   public OpMyTasksTestDataFactory(OpProjectSession session) {
      super(session);
   }
   ...
   public static XComponent createDataSet(List choices) {
      ...
      if (choices != null) {
         for (int i = 0; i < choices.size(); i++) {
            ...
            cell.setValue(OpProjectConstants.LINKED_ATTACHMENT_DESCRIPTOR);
            row.addChild(cell);
            // 1. choice
