...
public class OpActivityGraphMultiplierTest extends TestCase {
   ...
   private void makeLink(int source, int target) {
      ...
      //source is predecessor for target
      ...
      //target is successor for source
    ...
    * @throws Exception - Exception if anything fails.
    */
   public void testIncompleteSuccessorsCycle()
        throws Exception {
    ...
    * @throws Exception - Exception if anything fails.
    */
   public void testPredecessorsCycle()
        throws Exception {
    ...
    * @throws Exception - Exception if anything fails.
    */
   public void testCollectionCollectionLoop()
        throws Exception {

      //make link 6->2 and 3->5
      makeLink(6, 2);
      makeLink(3, 5);
    ...
    * @throws Exception - if anything fails.
    */
   public void testDetectLoopsCollectionToCollection()
        throws Exception {
    ...
    * @throws Exception - if anything fails.
    */
   public void testDetectLoopsInnerCollection()
        throws Exception {
      ...
      //can't be detected this way yet...
      //result = validator.detectLoops(7);
      //assertTrue("cycles should have been detected ", result);
   }
    ...
    * @throws Exception - if anything fails.
    */
   public void testNoLoopDetectLoops()
        throws Exception {
      makeLink(0, 1);
      makeLink(1, 3);
      makeLink(4, 5);
   ...
   public void testLinksLoop()
      ...
      //try to make activity 0 the successor of activity 0
      succ = new ArrayList();
      succ.add(new Integer(0));
      result = false;
      try {
      ...
      //try to make activity 0 the predecessor of activity 0
      ArrayList pred = new ArrayList();
      pred.add(new Integer(0));
      result = false;
      try {
    ...
    * @throws Exception - Exception if anything fails.
    */
   public void testLinksLoopCollectionToChild()
        throws Exception {

      ArrayList succ;

      //try to make activity 8 the successor of activity 7
      succ = new ArrayList();
      ...
      //predecessors
      //try to make activity 8 the predecessor of activity 7
      ArrayList pred = new ArrayList();
