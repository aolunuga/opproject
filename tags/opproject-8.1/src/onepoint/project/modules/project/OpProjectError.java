...
public interface OpProjectError {
   ...
   public final static int CANNOT_CHANGE_ACTIVITY_TYPE_ERROR = 30;
   
   public final static int PROJECTS_STILL_REFERNCED_ERROR = 32;
   public final static int PROJECTS_STILL_REFERNCED_WARNING = 33;

   public final static int PROJECT_IS_PROGRAM_ERROR = 33;
   public final static int NO_PERMISSION_CHANGING_ARCHIVED_STATE_ERROR = 34;
   ...
   public final static String PROJECTS_STILL_REFERNCED_ERROR_NAME = "ProjectsStillReferencedWarning";
   public final static String PROJECTS_STILL_REFERNCED_WARNING_NAME = "ProjectsStillReferencedError";
   public final static String PROJECT_IS_PROGRAM_ERROR_NAME = "ProjectIsProgram";
   public final static String NO_PERMISSION_CHANGING_ARCHIVED_STATE_ERROR_NAME = "NoPermissionChangingArchived";
}
