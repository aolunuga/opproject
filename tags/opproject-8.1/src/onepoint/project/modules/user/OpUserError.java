...
public interface OpUserError {
   ...
   public final static int USER_LINKED = 26;
   public final static int CONTROLLING_SHEETS_EXIST = 27;
   public final static int LOCKS_EXIST = 28;
   public final static int WORKSLIPS_EXIST = 29;
   ...
   public static final String USER_LINKED_NAME = "UserLinkedError";
   public static final String CONTROLLING_SHEETS_EXIST_NAME = "ControllingSheetsExist";
   public static final String LOCKS_EXIST_NAME = "LocksExist";
   public static final String WORKSLIPS_EXIST_NAME = "WorkslipsExist";
}
