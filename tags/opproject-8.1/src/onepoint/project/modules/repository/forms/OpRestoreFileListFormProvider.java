...
public class OpRestoreFileListFormProvider implements XFormProvider {
    ...
    * This class logger
    */
   private final static XLog logger = XLogFactory.getLogger(OpRestoreFileListFormProvider.class);
   ...
   private File[] getBackupFiles(File backupRootDir) {
      ...
      Arrays.sort(backupFiles, new Comparator() {
         public int compare(Object o1, Object o2) {
            ...
            long modifiedDiff = file1.getName().compareToIgnoreCase(file2.getName());
