...
public abstract class OpWorkValidator extends XValidator {
   ...
   public static int PROJECT_CHOICE_SET_ORDER_INDEX = 0;
   public static int PROJECT_CHOICE_SET_ACTIVITY_INDEX = 1;
   public static int PROJECT_CHOICE_SET_RESOURCE_INDEX = 2;
   public static int PROJECT_PROGRESS_TRACKED_INDEX = 3;

   public static int RESOURCE_CHOICE_SET_ORDER_INDEX = 0;
   public static int RESOURCE_CHOICE_SET_ACTIVITY_INDEX = 1;

   public static int ACTIVITY_CHOICE_SET_ORDER_INDEX = 2;
   public static int ACTIVITY_CHOICE_SET_ACTIVITY_TYPE_INDEX = 0;
   public static int ACTIVITY_CHOICE_SET_ACTIVITY_COSTS_INDEX = 1;
   public static int ACTIVITY_CHOICE_SET_RESOURCE_INDEX = 3;
   ...
   protected static final int ACTIONS_STATUS = 4;
    ...
    */
   public void setValue(XComponent row, int index, Object value, boolean enabled) {
      XComponent dataCell = (XComponent) row.getChild(index);
      dataCell.setValue(value);
      dataCell.setEnabled(enabled);
      dataCell.repaint();
   }
   ...
   protected String getProjectChoiceByActivity(String activityChoice) {
      ...
      for (int i = 0; i < getProjectSet().getChildCount(); i++) {
         ...
         activityChoiceList = ((XComponent) projectRow.getChild(PROJECT_CHOICE_SET_ACTIVITY_INDEX)).getListValue();
