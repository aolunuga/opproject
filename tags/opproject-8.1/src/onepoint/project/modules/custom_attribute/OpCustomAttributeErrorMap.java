...
public class OpCustomAttributeErrorMap extends XErrorMap {
   ...
   public OpCustomAttributeErrorMap() {
      ...
      registerErrorCode(OpCustomAttributeError.CUSTOM_VALUES_STILL_EXIST_ERROR, OpCustomAttributeError.CUSTOM_VALUES_STILL_EXIST_NAME);
      registerErrorCode(OpCustomAttributeError.CUSTOM_TYPES_STILL_EXIST_ERROR, OpCustomAttributeError.CUSTOM_TYPES_STILL_EXIST_NAME);
   }
