...
public class OpNewPoolFormProvider implements XFormProvider {
   ...
   public void prepareForm(XSession s, XComponent form, HashMap parameters) {
      ...
      try {
         ...
         prepareAdvancedFeatures(session, broker, form, superPool);
      }
      finally {
         broker.close();
      }
   ...
   protected void prepareAdvancedFeatures(OpProjectSession session, OpBroker broker, XComponent form, OpResourcePool superPool) {
   }
}
