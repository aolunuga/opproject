...
public final class OpHibernateSchemaUpdater {
    ...
    * This class's logger.
    */
   private static final XLog logger = XLogFactory.getLogger(OpHibernateSchemaUpdater.class);
   ...
   static {
      ...
      DB_TYPES_MAP.put(new Integer(OpHibernateSource.DERBY), new Integer(OpSqlStatementFactory.DERBY));
   }
    ...
    * @return a <code>List</code> of <code>String</code> representing SQL statements.
    */
   public List<String> generateDropFKConstraints(String tableName, String columnName, DatabaseMetaData dbMetaData) {
      List<String> dropFkConstraints = new ArrayList<String>();
      if (statement != null) {
         try {
            ResultSet rs = dbMetaData.getImportedKeys(null, null, tableName);
