...
public class OpHourlyRatesPeriod extends OpObject {
   ...
   public boolean equalValues(OpHourlyRatesPeriod other) {
      return other != null && other.externalRate == this.externalRate
            && other.internalRate == this.internalRate && other.start.equals(this.start)
            && other.finish.equals(this.finish);
   }
