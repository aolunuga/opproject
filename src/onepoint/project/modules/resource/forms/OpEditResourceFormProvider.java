...
public class OpEditResourceFormProvider implements XFormProvider {
   ...
   public void prepareForm(XSession s, XComponent form, HashMap parameters) {
      ...
      try {
         ...
         XComponent archived = form.findComponent(OpResource.ARCHIVED);
         archived.setBooleanValue(resource.isArchived());
         ...
         OpObjectOrderCriteria projectOrderCriteria = new OpObjectOrderCriteria(OpProjectNode.class, OpProjectNode.NAME, OpObjectOrderCriteria.ASCENDING);
         ...
         prepareAdvancedFeatures(session, broker, form, editMode, resource);
      }
      finally {
         broker.close();
      }
    ...
    * @param resource
    */
   protected void prepareAdvancedFeatures(OpProjectSession session, OpBroker broker, XComponent form, Boolean editMode, OpResource resource) {
   }
}
