...
public class OpEditPoolFormProvider implements XFormProvider {
   ...
   public void prepareForm(XSession s, XComponent form, HashMap parameters) {
      ...
      try {
         ...
         prepareAdvancedFeatures(session, broker, form, edit_mode.booleanValue(), pool);
      }
      finally {
         broker.close();
      }
   ...
   protected void prepareAdvancedFeatures(OpProjectSession session, OpBroker broker, XComponent form, Boolean editMode, OpResourcePool pool) {
   }
}
