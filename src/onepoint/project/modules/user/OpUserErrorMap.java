...
public class OpUserErrorMap extends XErrorMap {
   ...
   protected OpUserErrorMap() {
      ...
      registerErrorCode(OpUserError.USER_LINKED, OpUserError.USER_LINKED_NAME);

      registerErrorCode(OpUserError.CONTROLLING_SHEETS_EXIST, OpUserError.CONTROLLING_SHEETS_EXIST_NAME);
      registerErrorCode(OpUserError.WORKSLIPS_EXIST, OpUserError.WORKSLIPS_EXIST_NAME);
      registerErrorCode(OpUserError.LOCKS_EXIST, OpUserError.LOCKS_EXIST_NAME);
   }
