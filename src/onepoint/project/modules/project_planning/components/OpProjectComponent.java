...
public class OpProjectComponent extends XComponent {
   ...
   static {
      ...
      /*
       * // Default Gantt project style DEFAULT_GANTT_PROJECT_STYLE_ATTRIBUTES = new XStyle();
       * DEFAULT_GANTT_PROJECT_STYLE_ATTRIBUTES.foreground = Color.BLACK; _addDefaultStyle(DEFAULT_GANTT_PROJECT_STYLE,
       * DEFAULT_GANTT_PROJECT_STYLE_ATTRIBUTES); // Default Gantt milestone style
       * DEFAULT_GANTT_MILESTONE_STYLE_ATTRIBUTES = new XStyle(); DEFAULT_GANTT_MILESTONE_STYLE_ATTRIBUTES.foreground =
       * Color.BLACK; DEFAULT_GANTT_MILESTONE_STYLE_ATTRIBUTES.selection_foreground = Color.RED;
       * DEFAULT_GANTT_MILESTONE_STYLE_ATTRIBUTES.left = 2; DEFAULT_GANTT_MILESTONE_STYLE_ATTRIBUTES.right = 2;
       * DEFAULT_GANTT_MILESTONE_STYLE_ATTRIBUTES.top = 2; DEFAULT_GANTT_MILESTONE_STYLE_ATTRIBUTES.bottom = 2;
       * _addDefaultStyle(DEFAULT_GANTT_MILESTONE_STYLE, DEFAULT_GANTT_MILESTONE_STYLE_ATTRIBUTES); // Default Gantt
       * task style DEFAULT_GANTT_TASK_STYLE_ATTRIBUTES = new XStyle(); DEFAULT_GANTT_TASK_STYLE_ATTRIBUTES.background =
       * Color.BLACK; DEFAULT_GANTT_TASK_STYLE_ATTRIBUTES.foreground = Color.BLACK;
       * DEFAULT_GANTT_TASK_STYLE_ATTRIBUTES.selection_foreground = Color.RED; DEFAULT_GANTT_TASK_STYLE_ATTRIBUTES.top =
       * 2; DEFAULT_GANTT_TASK_STYLE_ATTRIBUTES.bottom = 2; DEFAULT_GANTT_TASK_STYLE_ATTRIBUTES.gap = 3;
       * _addDefaultStyle(DEFAULT_GANTT_TASK_STYLE, DEFAULT_GANTT_TASK_STYLE_ATTRIBUTES);
       */
