 ...
 */
public class OpCostRecord extends OpCustomizableObject implements OpSubTypable {
   ...
   // cost types currently not in cost records...
   public static final byte PERSONELL_COSTS = -1;
   public static final byte PROCEEDS = -2;
   ...
   public void addAttachment(OpAttachment attachment) {
	   if (getAttachments() == null) {
		   setAttachments(new HashSet<OpAttachment>());
	   }
	   if (getAttachments().add(attachment)) {
