...
public class OpMindMeisterConnection extends OpWebApplicationConnection {
   ...
   private final static String JAXB_CLASS_PACKAGE = "onepoint.project.modules.external_applications.MindMeister.generated";
   ...
   public OpMindMeisterConnection(String url, String attachmentUrl,
         String authUrl, String apiKey, String secret, String token) {
      this.url = url;
   ...
   public String getFrob() throws OpExternalApplicationException {
      ...
      if (STAT_FAIL.equals(rsp.getStat())) {
         throw new OpExternalApplicationException(
               OpExternalApplicationException.APPLICATION_ERROR_EXCEPTION,
               OpMindMeisterApplication.APP_KIND, rsp.getErr().getMsg());
      }
      return rsp.getFrob();
   }
   ...
   public String getAuthenticationUrl(String frob)
      ...
      parameters.add(new Pair<String, String>(FROB, frob));
      // parameters.add(new Pair<String, String>(CALLBACK_URL, "http://www.onepoint.at/"));
   ...
   public Rsp sendRequest(String method, List<Pair<String, String>> parameters) throws OpExternalApplicationException {
      ...
      try {
         ...
         throw new OpExternalApplicationException(
               OpExternalApplicationException.INTERNAL_ERROR_EXCEPTION,
               OpMindMeisterApplication.APP_KIND, "jaxb", e);
