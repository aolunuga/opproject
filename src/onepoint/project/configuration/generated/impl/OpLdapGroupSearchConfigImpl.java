...
public class OpLdapGroupSearchConfigImpl implements onepoint.project.configuration.generated.OpLdapGroupSearchConfig, com.sun.xml.bind.JAXBObject, onepoint.project.configuration.generated.impl.runtime.UnmarshallableObject, onepoint.project.configuration.generated.impl.runtime.XMLSerializable, onepoint.project.configuration.generated.impl.runtime.ValidatableObject
{

    protected java.lang.String _SearchScope;
    protected java.lang.String _SearchFilter;
    protected java.lang.String _SearchBase;
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (onepoint.project.configuration.generated.OpLdapGroupSearchConfig.class);
    }
    ...
    public void setSearchScope(java.lang.String value) {
        _SearchScope = value;
    }
    ...
    public void setSearchFilter(java.lang.String value) {
        _SearchFilter = value;
    }
    ...
    public onepoint.project.configuration.generated.impl.runtime.UnmarshallingEventHandler createUnmarshaller(onepoint.project.configuration.generated.impl.runtime.UnmarshallingContext context) {
        return new onepoint.project.configuration.generated.impl.OpLdapGroupSearchConfigImpl.Unmarshaller(context);
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        try {
            context.text(((java.lang.String) _SearchFilter), "SearchFilter");
        } catch (java.lang.Exception e) {
            onepoint.project.configuration.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("", "search-base");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _SearchBase), "SearchBase");
        } catch (java.lang.Exception e) {
            onepoint.project.configuration.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
        context.startElement("", "search-scope");
        context.endNamespaceDecls();
        context.endAttributes();
        try {
            context.text(((java.lang.String) _SearchScope), "SearchScope");
        } catch (java.lang.Exception e) {
            onepoint.project.configuration.generated.impl.runtime.Util.handlePrintConversionException(this, e, context);
        }
        context.endElement();
...
+"-t\u0000\rsearch-filtert\u0000\u0000sq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000ppq\u0000~\u0000\u000fsq\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000"
+"%pq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\u000bsearch-baseq\u0000~\u00007sq\u0000~\u0000\u0007pp\u0000sq\u0000~\u0000\u0000pps"
...
+"teType;L\u0000\tfacetNameq\u0000~\u0000\u0014xq\u0000~\u0000\u0013q\u0000~\u00007pq\u0000~\u0000\u001b\u0000\u0000q\u0000~\u0000\u0016q\u0000~\u0000\u0016t\u0000\u000benum"
+"erationsr\u0000\u0011java.util.HashSet\u00baD\u0085\u0095\u0096\u00b8\u00b74\u0003\u0000\u0000xpw\f\u0000\u0000\u0000\u0010?@\u0000\u0000\u0000\u0000\u0000\u0003t\u0000\u0007su"
+"btreet\u0000\bonelevelt\u0000\u0006objectxq\u0000~\u0000\u001dsq\u0000~\u0000\u001et\u0000\u000estring-derivedq\u0000~\u00007s"
+"q\u0000~\u0000 ppsq\u0000~\u0000\"q\u0000~\u0000%pq\u0000~\u0000&q\u0000~\u0000/q\u0000~\u00003sq\u0000~\u0000-t\u0000\fsearch-scopeq\u0000~\u00007"
...
+"ool;xp\u0000\u0000\u0000\b\u0001pq\u0000~\u0000\u0005q\u0000~\u0000\u000bq\u0000~\u00009q\u0000~\u0000\u0006q\u0000~\u0000?q\u0000~\u0000!q\u0000~\u0000:q\u0000~\u0000Px"));
        ...
        extends onepoint.project.configuration.generated.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return onepoint.project.configuration.generated.impl.OpLdapGroupSearchConfigImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  0 :
                        ...
                        break;
                    case  6 :
                        if (("search-scope" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 7;
                            return ;
                        }
                    ...
                    case  9 :
                        ...
                        return ;
                    case  3 :
                        if (("search-base" == ___local)&&("" == ___uri)) {
                            context.pushAttributes(__atts, true);
                            state = 4;
                            return ;
                        }
