...
public final class OpEnvironmentManager {
    ...
    */
   static {
      if (OpEnvironmentManager.OS_NAME.startsWith("Mac") || OpEnvironmentManager.OS_NAME.startsWith("Linux")) {
         OpEnvironmentManager.COMMAND = "env";
      }
      else if (OpEnvironmentManager.OS_NAME.equals("Windows 95") || OpEnvironmentManager.OS_NAME.equals("Windows 98") || OpEnvironmentManager.OS_NAME.equals("Windows Me")) {
         OpEnvironmentManager.COMMAND = "command.com /C set";
      }
      else if (OpEnvironmentManager.OS_NAME.startsWith("Windows")) {
   ...
   public static boolean isOpenEdition() {
      return OpProjectConstants.BASIC_EDITION_CODE.equals(productCode) || 
             OpProjectConstants.OPEN_EDITION_CODE.equals(productCode);
   }
