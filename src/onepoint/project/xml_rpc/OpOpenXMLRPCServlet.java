...
public class OpOpenXMLRPCServlet extends XmlRpcServlet {
    ...
    * the logger
    */
   private static final XLog logger = XLogFactory.getLogger(OpOpenXMLRPCServlet.class);
   ...
   private static final String XMLRPC_PKG_SUFFIX = "xmlrpc";
...
//   }
   ...
   private Class getXMLRPCServiceClass(OpService service) {
      ...
      try {
         ...
         String className = serviceClass.getPackage().getName() + "." + XMLRPC_PKG_SUFFIX + "." + serviceClass.getSimpleName();
