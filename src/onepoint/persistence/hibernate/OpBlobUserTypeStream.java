...
public class OpBlobUserTypeStream extends InputStream {
    ...
    */
   private static final XLog logger = XLogFactory.getServerLogger(OpBlobUserTypeStream.class);
   ...
   public int read()
      ...
      if (broker != null && databaseStream.available() > 0) {
         return databaseStream.read();
      }
      else {
         closeBroker();
         return -1;
